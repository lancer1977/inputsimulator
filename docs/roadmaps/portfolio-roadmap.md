# inputsimulator portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 4
- Files changed (90 days): 53
- Last signal: 6d91b01 (4 days ago)
- Top modified areas: WindowsInput(24);docs(9);WindowsInput.Tests(7);00_agile(6);WindowsInput.SampleClient.Wpf(5);README.md(1)
- Notes: clean_at_scan
...
- [ ] Document owner and intent for area: WindowsInput(24)
